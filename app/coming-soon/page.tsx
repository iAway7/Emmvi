 ...
 * outreach.
 *
 * El title y la description describen Emmvi, no el estado del sitio: si un
 * buscador la indexa mientras esta activa, el resultado sigue siendo util.
 */
export const metadata: Metadata = {
  // absolute: sin esto la plantilla "%s · Emmvi" del layout se aplica (es un
  // segmento hijo, la home no lo es) y el titulo sale duplicado.
