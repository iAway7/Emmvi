...
/**
 * Fecha y plazos en lib/privacy.ts, compartidos con la version española para
 * que no puedan diverger.
 */
const LAST_UPDATED = new Date(PRIVACY_LAST_UPDATED).toLocaleDateString("en-GB", {
  day: "numeric",
  month: "long",
  year: "numeric",
  timeZone: "UTC",
...
export default function PrivacyPolicy() {
  return (
    <>
      <SiteHeader path="/privacy-policy" />
      ...
      <SiteFooter path="/privacy-policy" />
    </>
  );
}
